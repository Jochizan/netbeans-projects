...
public class Principal extends JFrame implements ActionListener{
  ...
  public Principal(){
    ...
    labelLogo.setBounds(5,5,300,50);
    add(labelLogo);
  ...
  public void actionPerformed(ActionEvent e){
           ...
           Departamento.equals("") || Antiguedad.equals("")){
            ...
            if(Departamento.equals("Atención al Cliente")){
                            ...
                            if(Antiguedad.equals("1 año de servicio")){
                                    textarea1.setText("\n El tranajador" + nombreTrabajador + " " + AP + " " + AM +
                                                      "\n quien labora en " + Departamento + " con " + Antiguedad +                                                             
                                                      "\n recibe 6 días de vaciones. ");                                                             
                            }
                            if(Antiguedad.equals("2 a 6 años de servicio")){
                                    textarea1.setText("\n El tranajador" + nombreTrabajador + " " + AP + " " + AM +
                                                      "\n quien labora en " + Departamento + " con " + Antiguedad +                                                             
                                                      "\n recibe 14 días de vaciones. ");                                                            
                            }
                            if(Antiguedad.equals("7 años o más de servicio")){
                                    textarea1.setText("\n El tranajador" + nombreTrabajador + " " + AP + " " + AM +
                                                      "\n quien labora en " + Departamento + " con " + Antiguedad +                                                             
                                                      "\n recibe 20 días de vaciones. ");                                                           
                            }
                            ...
                            if(Antiguedad.equals("1 año de servicio")){
                                    textarea1.setText("\n El tranajador" + nombreTrabajador + " " + AP + " " + AM +
                                                      "\n quien labora en " + Departamento + " con " + Antiguedad +                                                             
                                                      "\n recibe 8 días de vaciones. ");                                                             
                            }
                            if(Antiguedad.equals("2 a 6 años de servicio")){
                                    textarea1.setText("\n El tranajador" + nombreTrabajador + " " + AP + " " + AM +
                                                      "\n quien labora en " + Departamento + " con " + Antiguedad +                                                             
                                                      "\n recibe 18 días de vaciones. ");                                                            
                            }
                            if(Antiguedad.equals("7 años o más de servicio")){
                                    textarea1.setText("\n El tranajador" + nombreTrabajador + " " + AP + " " + AM +
                                                      "\n quien labora en " + Departamento + " con " + Antiguedad +                                                             
                                                      "\n recibe 25 días de vaciones. ");                                                            
                            }
    ...
    if (e.getSource() == miElCreador){
        ...
        JOptionPane.showMessageDialog(null,"Desarrollado por Industries Lanjo\n" +
