...
public class interfazMatriz2 implements ActionListener {
    ...
    public class ventanaRespuesta { //clase que contiene la ventana para mostrar los resultados
        ...
        public ventanaRespuesta(int[][] r) {//constructor, recibe como parametro el arreglo a mostrar
